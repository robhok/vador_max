...
function hugeit_slider_html_show_styles( $param_values, $op_type ) {
	...
	<style>
        ...
        <div>
	        ...
	        <div
		        class="free_version_banner" <?php if ( isset( $_COOKIE['hgSliderFreeBannerShow'] ) && isset( $_COOKIE['hgSliderFreeBannerShow'] ) == "no" ) {
		        ...
		        <p class="usermanual_text">If you have any difficulties in using the options, Follow the link to <a
				        href="http://huge-it.com/wordpress-slider-user-manual/" target="_blank">User Manual</a></p>
	        ...
	        <div id="poststuff">
		        ...
		        <div id="post-body-content" class="slider-options">
			        <div id="post-body-heading">
				        <h3>Advanced Features PRO<p class="hugeit_slider_free_attention">These options are disabled in Lite version. Please, upgrade to PRO license to be able to use.</p></h3>
					        ...
					        <form action="admin.php?page=Options_slider_styles" method="post" id="adminForm"
						        ...
						        <div class="options-block" id="options-block-slider">
							        ...
							        <div>
								        ...
								        <input name="params[slider_slider_background_color]" type="text" class="color"
								               id="slider_slider_background_color"
								               value="#<?php echo $param_values['slider_slider_background_color']; ?>"
								               size="10">
							        </div>
							        ...
							        <div class="has-background">
								        ...
								        <input type="text" name="params[slider_slideshow_border_size]"
								               id="slider_slideshow_border_size"
								               value="<?php echo $param_values['slider_slideshow_border_size']; ?>"
								               class="text"/>
							        </div>
							        <div>
								        ...
								        <input name="params[slider_slideshow_border_color]" type="text" class="color"
								               id="slider_slideshow_border_color"
								               value="#<?php echo $param_values['slider_slideshow_border_color']; ?>"
								               size="10">
							        </div>
							        <div class="has-background">
								        ...
								        <input type="text" name="params[slider_slideshow_border_radius]"
								               id="slider_slideshow_border_radius"
								               value="<?php echo $param_values['slider_slideshow_border_radius']; ?>"
								               class="text"/>
							        </div>
							        <div>
						        ...
						        <div class="options-block" id="options-block-description">
							        ...
							        <div>
								        ...
								        <input type="checkbox"
								               id="slider_description_has_margin" <?php if ( $param_values['slider_description_has_margin'] == 'on' ) {
						        ...
						        <div class="options-block" id="options-block-thumbnail">
							        ...
							        <div class="has-background">
								        ...
								        <input type="text" name="params[slider_thumb_count_slides]"
								               id="slider_thumb_count_slides"
								               value="<?php echo $param_values['slider_thumb_count_slides']; ?>"
								               class="text"/>
							        </div>
									<div>
						        ...
						        <div class="options-block" id="options-block-navigation">
									...
									<div>
										...
										<input type="text" class="color text" name="params[slider_dots_color]" id="slider_dots_color" value="<?php echo $param_values['slider_dots_color']; ?>" />
									</div>
									<div class="has-background">
										...
										<input type="text" class="color text" name="params[slider_active_dot_color]" id="slider_active_dot_color" value="<?php echo $param_values['slider_active_dot_color']; ?>" />
									</div>
								</div>
