...
PEXETO.tinymce.buttons=[
		...
		},
		{
			...
			var imgclass=obj.align==='none'?'':'align'+obj.align,
				width = obj.width ? ' width="'+obj.width+'"':'';
				return '<div><a data-rel="lightbox" class="lightbox-image" href="'+obj.href+'" title="'+obj.description+'"><img class="img-frame '+imgclass+'"'+width+' src="'+obj.src+'" /></a></div>';
			}
		},
		{
			id:'pexetobutton',
			...
			title:'Button',
			allowSelection:false,
			fields:[{id:'text', name:'Text', twocolumn:'first'},
				{id:'href', name:'Link URL', twocolumn:'last'},
				{id:'link_open', name:'Open link in', twocolumn:'first', values:
					[{name:'Same tab / window', id:'same'}, {name:'New tab / window', id:'new'}]},
				{id:'color', name:'Color', type:'colorpicker', twocolumn:'last'}],
			generateHtml:function(obj){
				var style=obj.color?'style="background-color:#'+obj.color+';"':'',
					target = obj.link_open=='new' ? ' target="_blank"':'';
				return '<a class="button" '+style+target+' href="'+obj.href+'"><span>'+obj.text+'</span></a>&nbsp;';
			}
		},
		{
			id:'pexetoinfoboxes',
		...
		},
		{
			...
			fields:[{id:'set', name:'Select services set', values:PEXETO.servicesBoxes, desc:'You can create services sets in '+PEXETO.themeName+' &raquo; Services Boxes section.'},
					{id:'layout', name:'Services Layout', imgradio:true, values:[
						{id:'default', name:'Default Style', hide:['bgcolor', 'textcolor'], img:PEXETO.tinymce.btnImageUri+'services-default.png', defaults:{}},
						{id:'boxed-photo', name:'Boxed Photo Style', hide:['bgcolor', 'textcolor'], img:PEXETO.tinymce.btnImageUri+'services-photo.png', defaults:{}},
						{id:'icon', name:'Icon Style', hide:['bgcolor', 'textcolor'], img:PEXETO.tinymce.btnImageUri+'services-icon.png', defaults:{}},
						{id:'thumbnail', name: 'Thumbnail Style', hide:['columns', 'bgcolor', 'textcolor'], img:PEXETO.tinymce.btnImageUri+'services-circle.png', defaults:{}},
						{id:'fullbox', name:'Full-width Grid', hide:['parallax'], img:PEXETO.tinymce.btnImageUri+'services-grid.png', defaults:{bgcolor:'252525', textcolor:'ffffff'}},
					]},
		...
		},
		{
			...
			fields:[{id:'cat', name:'Show items from portfolio category', values:PEXETO.portfolioCategories},
					...
					{id:'maxnum', name:'Maximum number of items', twocolumn:'first'},
					{id:'spacing', name:'Spacing between items', values:[{name:'Add spacing', id:'true'}, {name:'No spacing', id:'false'}], twocolumn:'last'},
					...
					{id:'height', name:'Thumbnail Height', desc:'(Optional) Custom thumbnail height in pixels'},
					{id:'lightbox_type', name:'Lightbox Preview Type', values:[{name:'Single Image Preview', id:'single'}, {name:'Album Preview', id: 'album'}], desc: 'Select whether the lightbox items will show a single preview image or an album of images per item.'}
					],
		...
		},
		{
			...
			title:'Fade Slider',
			allowSelection:false,
			fields:[{id:'sliderid', name:'Name of slider', values:PEXETO.nivoSliders, desc:'You can create a Fade slider in '+PEXETO.themeName+' &raquo; Fade Slider section.'}],
		...
		},
		{
			...
			title:'Pricing Table',
			allowSelection:false,
			fields:[{id:'set', name:'Select a pricing table', values:PEXETO.pricing, desc:'You can create pricing tables in '+PEXETO.themeName+' &raquo; Pricing Tables section.'},
			{id:'columns', name:'Number of columns', values:['3', '2', '4'], twocolumn:'first'},
			{id:'color', name:'Custom highlight color', type:'colorpicker', twocolumn:'last'}],
		...
		},
		{
			...
			fields:[{id:'small_title', name:'Small Title'},
				...
				{id:'button_link_open', name:'Open link in', twocolumn:'first', values:
					[{name:'Same tab / window', id:'same'}, {name:'New tab / window', id:'new'}]},
				{id:'button_color', name:'Custom Button Color', type:'colorpicker', twocolumn:'last'}],
		...
		},
		{
			...
			fields:[
				...
				{id:'style', name:'Select a base style', imgradio:true, hideTitle:true, values:[
						{name:'Light Background', id:'section-light', img:PEXETO.tinymce.btnImageUri+'bg-style-light.png', defaults:{bgcolor:'f7f7f7', textcolor:'777777', titlecolor:'252525'}}, 
						{name:'Light Background 2', id:'section-light2', img:PEXETO.tinymce.btnImageUri+'bg-style-light2.png', defaults:{bgcolor:'EDF5F7', textcolor:'777777', titlecolor:'252525'}},
						{name:'Light Background + Background Image', id:'section-light-bg', img:PEXETO.tinymce.btnImageUri+'bg-style-light-bg.png', defaults:{bgcolor:'f7f7f7', textcolor:'373737', titlecolor:'252525', imageopacity:'0.5'}},
						{name:'Dark Background', id:'section-dark', img:PEXETO.tinymce.btnImageUri+'bg-style-dark.png', defaults:{bgcolor:'252525', textcolor:'ffffff', titlecolor:'ffffff'}}, 
				...
				{id:'bgimagestyle', name:'Background Image Style', values:[
					...
					{'id':'background-contain', 'name':'Static Contain'}
					], twocolumn:'last'},
				{id:'titlecolor', name:'Title Color', type:'colorpicker', twocolumn:'first'},
				{id:'textcolor', name:'Text Color', type:'colorpicker', twocolumn:'last'},
				{id:'height', name:'Section Height', twocolumn:'first', desc:'(Optional) Minimum height of the section in pixels'}],
...
PEXETO.tinymce.btnManager.prototype.replaceShortcodeWithImg=function(co, ed){
	...
	rg = ed.id === 'content' || ed.id === 'wpb_tinymce_content'?
...
PEXETO.tinymce.btnManager.prototype.executeCommand=function(ed, btn){
	...
	var html='',
		...
		value,
		self = this,
		inner = ed.id === 'content' || ed.id === 'wpb_tinymce_content' ? false : true;
...
PEXETO.tinymce.btnManager.prototype.setButtonVisibility = function(){
	var $select = $('select[name="page_template"]'),
		$btn = $('.mce-i-pexetobgsection').parents('.mce-widget:first'),
	...
	//hide the background section button from the edit post screens
	if($('.post-type-post, .post-type-product, .post-type-portfolio').length){
		$btn.hide();
	}
	...
	$('.mce-i-pexetoframe').not('.pexeto-dialog .mce-i-pexetoframe').parents('.mce-widget:first').hide();
};
	...
	for(var i=0, length=btn.fields.length; i<length; i++){
		...
		if(field.values){
			...
			if(field.textarea && !PEXETO.tinymce.opera){
				...
				var data = 'data-fieldid="'+self.idPrefix+field.id+'" data-type="text"';
				if(defValue){
					data+=' data-url="'+defValue+'"';
				}
				inputHtml='<div class="pexeto-upload" '+data+'></div>';
			}else{
				//input field
				var inputClass="",
...
PEXETO.tinymce.formBuilder.prototype.initElements = function(){
	...
	$el.find('.pexeto-upload').each(function(){
	...
	var self = this,
		...
		getSelectedValue = function($el){
			...
			if($el.length==1){
				...
				//it's a radio element
				return $el.filter(':checked').val();
			}
		},
		setFieldsVisibility = function(field, $select){
			var i,
				selectedVal = getSelectedValue($select),
